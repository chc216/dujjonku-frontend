...
const mockTodayWords = [
    { id: 1, word: "두쫀쿠", meaning: "두바이쫀득쿠키", example: "우리 두쫀쿠 먹으러 갈래?" },
    { id: 2, word: "중꺾마", meaning: "중요한 것은 꺾이지 않는 마음", example: "이번 프로젝트 힘들지만 중꺾마 마인드 고고"},
    { id: 3, word: "럭키비키", meaning: "초긍정적 마인드", example: "비가 오네? 오히려 시원하고 럭키비키잖아~"},
    { id: 4, word: "점메추", meaning: "점심 메뉴 추천", example: "오늘 점메추 좀 해줘. 배고파."},
    { id: 5, word: "알잘딱깔센", meaning: "알아서 잘 딱 깔끔하고 센스있게", example: "이번 디자인은 알잘딱깔센으로 부탁해!"},
];
...
function TodayWordCard() {
    ...
    if (isLoading) {
        return (
            <CardContainer style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '300px' }}>
